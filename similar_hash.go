...
func SimHashSimilar(srcWordWeighs, dstWordWeights []gojieba.WordWeight) (distance int, err error) {
...
func simhashFingerPrint(wordWeights []gojieba.WordWeight) (fingerPrint []string, err error) {
